<template>
  <div>
    <header class="header">
      <h1 class="title">The Financier</h1>
      <nav class="navbar">
    ...
    <main>
      ...
      <section v-if="currentSection === 'home'" class="home-section">
        <div class="carousel-container">
          ...
          <img :src="carouselImages[currentImageIndex]" alt="Financier" class="bar-image">
          <button @click="nextImage" class="carousel-button next-button">&#10095;</button>
        </div>
        <div class="description">
          <h2>About the Financier</h2>
        ...
        <div class="location">
          ...
          <div class="location-content">
            <img src="/image/map1.png" alt="Map to the Financier" class="map-image">
