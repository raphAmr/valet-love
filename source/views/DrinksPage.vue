<template>
  <div class="drinks">
    ...
    <!-- Form to modify or add a drink -->
    <table v-if="action === 'edit'" class="table table-striped table-bordered table-hover">
      <tr><td>NAME</td>
        <td><input type="text" name="name_drink" v-model="oneDrink.name_drink" /></td></tr>
      <tr><td>PRODUCTION COST</td>
        <td><input type="number" name="price_production_drink" v-model="oneDrink.price_production_drink" /></td></tr>
      <tr><td>SELLING PRICE</td>
        <td><input type="number" name="price_selling_drink" v-model="oneDrink.price_selling_drink" /></td></tr>
      <tr><td>INGREDIENTS</td>
        <td><input type="text" name="ingredient_drink" v-model="oneDrink.ingredient_drink" /></td></tr>
      <tr><td>QUANTITY</td>
        <td><input type="number" name="quantity_drink" v-model="oneDrink.quantity_drink" /></td></tr>
      <tr><td colspan="2">
...
export default {
  ...
  data() {
    return {
      drinks: [], // Empty array to load data from JSON
      oneDrink: {
        id_drink: 0,
        name_drink: '',
