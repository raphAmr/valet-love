...
module.exports = {
    ...
    async getBarEmployees(barID) {
        try {
            const sql = "SELECT * FROM Employee WHERE id_bar = ?";
            console.log("[EMPLOYEE] Exécution de la requête SQL pour récupérer tous les employeedu bar...");
